...
#              Positive going from top to bottom
#
...
#            It allows for the objects to appear on the window
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            It is necessary whenever you have something that you want to see
#            on the window, i.e. you have rendered the window, otherwise the
#            window would close automatically and you would not get the chance
#            to see what is "attached" to that window.
#
