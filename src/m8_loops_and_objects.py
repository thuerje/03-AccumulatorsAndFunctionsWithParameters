...
def main():
    ...
    print_sequence1(20)
    draw_circles1(rg.Point(200,200),21)
    print_sequence2(18)
    draw_circles2(18)
    print_sequence3(100)
    draw_circles3(100)
...
def print_sequence1(n):
    ...
    """
    # ------------------------------------------------------------------
    # DONE Implement this function, per its doc-string above.
...
def draw_circles1(center_point,num_circles):
    """
...
def draw_circles2(x_range_change):
    """
    -- Constructs an rg.RoseWindow whose width and height are both 400.
...
def print_cosines(num_integers):
    """
    ...
    for k in range(num_integers):
        ans = math.cos(k+1)*80
        print(ans)

def draw_cosines_and_sines(num_circles_plus_one):
    """
    ...
    for k in range(num_circles_plus_one):
